...
class One( Frame ):
    def __init__( self, master ):
        ...
        #self.lblFName1 = Label(self.master, text='Path: ', font=("Helvetica", 16), fg='lightgray', bg='white')
       # self.lblFName1.grid(row=5, column=3, padx=(30,0), pady=(30,0))

        #self.lblFName2 = Label(self.master, text='Path: ', font=("Helvetica", 16), fg='lightgray', bg='white')
        #self.lblFName2.grid(row=5, column=3, padx=(30,0), pady=(30,0))

        #self.lblDisplay = Label(self.master, text='', font=("Helvetica", 16), fg='lightgray', bg='white')
        #self.lblDisplay.grid(row=5, column=3, padx=(30,0), pady=(30,0))
        ...
        self.btnClose.grid(row=5, column=2, padx=(30,0), pady=(10,0), sticky=SE)
